...
(define (space-remove-bodys space . bodys)
  (for-each (lambda (body) (space-remove-body space body)) bodys)
  space)
(define (space-remove-constraints space . constraints)
  (for-each
    (lambda (constraint) (space-remove-constraint space constraint))
    constraints)
  space)
(define (space-remove-shapes space . shapes)
  (for-each (lambda (shape) (space-remove-shape space shape)) shapes)
  space)
